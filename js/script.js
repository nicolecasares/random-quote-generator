...
let quotes = [
  {
    'name':  'Reshma Saujani, Founder of Girls Who Code',
  ...
  {
    'name': 'Sarah Friar, Chief Financial Officer at Square',
  ...
  {
    'name': 'Vanessa Hurst, Co-Founder of Girl Develop It',
